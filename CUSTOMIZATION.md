...
**Naming**: The file MUST be named `Frontend_Developer_Le_Thi_Y_Nhi.docx.pdf` to match the `resumeUrl` in `portfolio.ts`.
...
- [ ] Added Frontend_Developer_Le_Thi_Y_Nhi.docx.pdf to public/
- [ ] Tested dark mode
